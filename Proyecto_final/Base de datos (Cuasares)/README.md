...
Como observamos, es practicamente el mismo sql para los 3, lo único que cambia es el redshift máximo y mínimo, esto para dividir los archivos en 3 partes y poder hacer la consulta.
